...
10.10.2017 --> Lucia
En ModEmpleado:
- recibe dos contraseñas, saque una [@empContraseña1 varchar(10)]
- saque el if de que si las contraseñas son iguales [if(@empContraseña!=@empContraseña1) return -1]
- cambie los valores de return para que queden en orden 

En AltaEmpleado:
- recibe dos contraseñas, saque una [@empContraseña1 varchar(10)]
- saque el if de que si las contraseñas son iguales [if(@empContraseña!=@empContraseña1) return -1]
- saque: declare @Contra varchar(10)
...
create procedure ModEmpleado @empUsuario varchar(50),@empContraseña varchar(10) as
begin
...
if(exists(select * from Empleado where empUsuario=@empUsuario and empContraseña = @empContraseña))
...
--««««««««««««««««««««««««««««DATOS»»»»»»»»»»»»»»»»»»»»»»»»»»»»»»»»»»
---««««««««««««««««««««««««««««»»»»»»»»»»»»»»»»»»»»»»»»»»»»»»»»»»---
Exec AltaEmpleado 'Usuario 1','1234567890'
go
Exec AltaEmpleado 'Usuario 2','1234567890'
go
Exec AltaEmpleado 'Usuario 3','1234567890'
go
Exec AltaEmpleado 'Usuario 4','1234567890'
go
...
Exec AltaLocales 16, 'Legnani 123', 800, 'VENTA', 1, 2, 200, 'A', 'STL', 'Usuario1', true;  
go
